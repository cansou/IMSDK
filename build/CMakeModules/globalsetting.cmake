...
elseif(APPLE)
		...
		SET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Os -fembed-bitcode")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++11 -Os -fembed-bitcode")
		ADD_DEFINITIONS(-DXW64)
		ADD_DEFINITIONS(-DNDEBUG)
elseif (CMAKE_COMPILER_IS_GNUCC)
    SET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wall -Os -g -U_FORTIFY_SOURCE -fvisibility=hidden –fstack-protector-all -fPIC -ffunction-sections -fdata-sections")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++11 -g -Os -fPIC -fvisibility=hidden -fvisibility-inlines-hidden -ffunction-sections -fdata-sections")
    ADD_DEFINITIONS(-DXW64)
	  ADD_DEFINITIONS(-DNDEBUG)
endif (WIN32)
...
SET (COMMON_INCLUDE ${COMMON_DIR}/include ${COMMON_DIR}/youme_common/include ${COMMON_DIR}/build/thirdLib ${COMMON_DIR}/youme_common/include/YouMeCommon)
